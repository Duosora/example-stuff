                ...
                <div class="card mt-4 mb-4">
                    ...
                    <div class="card-body px-lg-5 pt-0">
                        <div class="text-center mt-2" style="color: #757575;">
                            <small><strong>IcyTape is the Hip-Hop, Rap, R&B community to discuss topics involving the culture.
                                    Write and share knowledge, news, music and connect with the best people.</strong></small>
                            <!-- Password -->
                            <div class="form-row">
                                <div class="col">
                            ...
                            <span style="text-align: center;">No accout? <a href="/register">Sign up</a></span>
                            <br />
                            <br />
